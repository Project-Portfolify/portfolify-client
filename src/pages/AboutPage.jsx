    ...
    <div className="min-h-screen bg-slate-100 dark:bg-slate-800 text-gray-800 dark:text-gray-100 flex items-center justify-center px-4 py-8">
      <div className="max-w-4xl">
        ...
        <p className="text-lg leading-relaxed mb-6 text-center">
          Welcome to <span className="font-bold">Portfolify</span> – a dynamic
          platform created to help you showcase your creativity and professional
          work. We are a passionate duo, <span className="font-bold">Uzma</span>{" "}
          and <span className="font-bold">David</span>, dedicated to providing a
          seamless and innovative experience for building your portfolio.
        </p>
        ...
        <p className="text-lg leading-relaxed mt-8 text-center">
          We would also like to extend our sincere gratitude to our mentor,
          <span className="font-bold"> Luis</span>, whose invaluable guidance
          and support have been instrumental in making this project a reality.
        </p>
      </div>
    </div>
  );
